...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('medications');

// This file contains the logic of every route in Forest Admin for the collection medications:
...
// Create a Medication
router.post('/medications', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Medication
router.put('/medications/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Medication
router.delete('/medications/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/medications', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Medications
router.get('/medications/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Medication
router.get('/medications/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Medications
router.get('/medications.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Medications
router.delete('/medications', permissionMiddlewareCreator.delete(), (request, response, next) => {
