...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('appointments');

// This file contains the logic of every route in Forest Admin for the collection appointments:
...
router.put('/appointments/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.delete('/appointments/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/appointments', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Appointments
router.get('/appointments/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Appointment
router.get('/appointments/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Appointments
router.get('/appointments.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
router.delete('/appointments', permissionMiddlewareCreator.delete(), (request, response, next) => {
