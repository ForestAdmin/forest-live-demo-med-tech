...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('clinics');

// This file contains the logic of every route in Forest Admin for the collection clinics:
...
// Create a Clinic
router.post('/clinics', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Clinic
router.put('/clinics/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Clinic
router.delete('/clinics/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/clinics', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Clinics
router.get('/clinics/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Clinic
router.get('/clinics/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Clinics
router.get('/clinics.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Clinics
router.delete('/clinics', permissionMiddlewareCreator.delete(), (request, response, next) => {
